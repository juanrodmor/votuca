...
class Authenticator
{
    ...
    private function generateRandomSecret($secretLength = 16)
    {
        $secret = '';
        $validChars = array(
            'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 
    ...
    private function getQR($name, $secret, $title = null, $params = array())
    {
    ...
    private function verifyCode($secret, $code, $discrepancy = 1, $currentTimeSlice = null)
    {
    ...
    private function setCodeLength($length)
    {
        $this->length  = $length;
